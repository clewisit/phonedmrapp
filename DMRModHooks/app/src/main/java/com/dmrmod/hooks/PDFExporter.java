...
public class PDFExporter {
    ...
    private static int addInstructions(PdfDocument document, int pageNumber) {
        ...
        paint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.NORMAL));
        y = drawBulletPoint(canvas, paint, "1. Transfer the backup folder from your phone to your computer", MARGIN, y, USABLE_WIDTH);
        y = drawBulletPoint(canvas, paint, "2. Open OpenGD77 CPS on your computer", MARGIN, y, USABLE_WIDTH);
