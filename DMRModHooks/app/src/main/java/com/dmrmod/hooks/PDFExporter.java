...
public class PDFExporter {
    ...
    private static int addInstructions(PdfDocument document, int pageNumber) {
        ...
        paint.setColor(Color.BLACK);
        y = drawWrappedText(canvas, paint, "Download the latest OpenGD77 CPS release for Windows, macOS, or Linux from the official GitHub releases page.", MARGIN, y, USABLE_WIDTH);
        y += 25;
        ...
        canvas.drawText("Generated by DMRModHooks v0.9.37 - LSPosed Module for Ulefone PriInterPhone", MARGIN, PAGE_HEIGHT - 30, paint);
