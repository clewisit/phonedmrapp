...
public class PDFExporter {
    ...
    private static int addInstructions(PdfDocument document, int pageNumber) {
        ...
        paint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.NORMAL));
        y = drawWrappedText(canvas, paint, "• Power levels: App Low=P1, App High=+W- (max). Import P1-P4=Low, P5-P9/+W-=High", MARGIN + 10, y, USABLE_WIDTH - 10);
        ...
        canvas.drawText("Generated by DMRModHooks v0.9.40 - LSPosed Module for Ulefone PriInterPhone", MARGIN, PAGE_HEIGHT - 30, paint);
