...
# Step 2: Check app
Write-Host "[2/6] Checking if app is installed..." -ForegroundColor Green
...
if ($probeLog.Count -eq 0) {
    Write-Host "WARNING: No probe logs found!" -ForegroundColor Yellow
...
if ($hasACK -and $hasWriteSupport -and $hasEraseSupport) {
    ...
    Write-Host "1. Review INTEGRATION_GUIDE.md Phase 1B" -ForegroundColor Yellow
    ...
    Write-Host ""
    Write-Host "CAUTION: Flash write operations are medium risk" -ForegroundColor Yellow
    ...
    Write-Host ""
    Write-Host "Next steps:" -ForegroundColor Yellow
    Write-Host "1. Review INTEGRATION_GUIDE.md Phase 2" -ForegroundColor Yellow
