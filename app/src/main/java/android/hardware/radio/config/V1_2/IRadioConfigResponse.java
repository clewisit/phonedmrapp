...
public interface IRadioConfigResponse extends android.hardware.radio.config.V1_1.IRadioConfigResponse {
    ...
    public static final class Proxy implements IRadioConfigResponse {
        ...
        public void getSimSlotsStatusResponse_1_2(RadioResponseInfo radioResponseInfo, ArrayList<SimSlotStatus> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 7:
                    ...
                    getSimSlotsStatusResponse_1_2(radioResponseInfo7, SimSlotStatus.readVectorFromParcel(hwParcel));
                    return;
                default:
                    switch (i) {
                        case 256067662:
