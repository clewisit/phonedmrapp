...
public interface IRadioConfigIndication extends android.hardware.radio.config.V1_0.IRadioConfigIndication {
    ...
    public static abstract class Stub extends HwBinder implements IRadioConfigIndication {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IRadioConfigIndication.kInterfaceName, android.hardware.radio.config.V1_0.IRadioConfigIndication.kInterfaceName, "android.hidl.base@1.0::IBase"}));
        }

        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{ByteCompanionObject.MAX_VALUE, -49, 22, ByteCompanionObject.MAX_VALUE, 89, 59, 16, -58, 123, 89, -85, 112, Const.Command.QUERY_SIGNAL_STRENGTH_CMD, 23, -127, -62, 106, 85, 117, -22, -74, 8, 3, -25, -53, -79, -63, 76, 113, 8, 90, 59}, new byte[]{Const.Command.SET_DIGITAL_INFO_CMD, -117, Const.Command.SET_VOL_CMD, -29, -56, -62, 118, -55, -16, -81, -83, Const.Command.RECEIVE_SMS_CMD, -61, 19, -54, 61, 107, -67, -98, 72, Const.Command.RECEIVE_SMS_CMD, -33, Const.Command.SET_POWER_SAVE_MODE_CMD, Const.Command.SET_SPK_EN_CMD, 114, 4, -58, 10, -39, -74, Const.Command.MODULE_PRINT_STATUS_INFO_CMD, -85}, new byte[]{-20, ByteCompanionObject.MAX_VALUE, -41, -98, -48, Const.Command.RECEIVE_SMS_CMD, -6, -123, -68, 73, -108, Const.Command.SET_LAUNCH_INFO_CMD, -83, -82, 62, -66, Const.Command.SET_ANALOG_INFO_CMD, -17, 5, Const.Command.QUERY_DIGITAL_INFO_CMD, -13, -51, 105, 87, 19, -109, Const.Command.QUERY_DIGITAL_INFO_CMD, -72, 59, 24, -54, 76}}));
        }
