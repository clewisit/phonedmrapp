...
public interface IRadioConfigResponse extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IRadioConfigResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IRadioConfigResponse.kInterfaceName, "android.hidl.base@1.0::IBase"}));
        }

        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-94, -23, -73, Const.Command.MODULE_INIT_CMD, 9, -9, -108, Const.Command.SET_LAUNCH_INFO_CMD, -9, 101, -125, -127, 116, -32, 75, 111, -102, 62, 108, -117, 118, -71, Const.Command.SET_ANALOG_INFO_CMD, -4, 23, 5, 99, Const.Command.SET_DIGITAL_INFO_CMD, 7, -70, -44, 75}, new byte[]{-20, ByteCompanionObject.MAX_VALUE, -41, -98, -48, Const.Command.RECEIVE_SMS_CMD, -6, -123, -68, 73, -108, Const.Command.SET_LAUNCH_INFO_CMD, -83, -82, 62, -66, Const.Command.SET_ANALOG_INFO_CMD, -17, 5, Const.Command.QUERY_DIGITAL_INFO_CMD, -13, -51, 105, 87, 19, -109, Const.Command.QUERY_DIGITAL_INFO_CMD, -72, 59, 24, -54, 76}}));
        }
