...
public interface IRadioConfigResponse extends android.hardware.radio.config.V1_2.IRadioConfigResponse {
    ...
    public static final class Proxy implements IRadioConfigResponse {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of android.hardware.radio.config@1.3::IRadioConfigResponse]@Proxy";
            }
        }
        ...
        public void getPhoneCapabilityResponse(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, PhoneCapability phoneCapability) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.radio.config.V1_1.IRadioConfigResponse.kInterfaceName);
            radioResponseInfo.writeToParcel(hwParcel);
        ...
        public void getSimSlotsStatusResponse_1_2(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, ArrayList<android.hardware.radio.config.V1_2.SimSlotStatus> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.radio.config.V1_2.IRadioConfigResponse.kInterfaceName);
            radioResponseInfo.writeToParcel(hwParcel);
            android.hardware.radio.config.V1_2.SimSlotStatus.writeVectorToParcel(hwParcel, arrayList);
            HwParcel hwParcel2 = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IRadioConfigResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IRadioConfigResponse.kInterfaceName, android.hardware.radio.config.V1_2.IRadioConfigResponse.kInterfaceName, android.hardware.radio.config.V1_1.IRadioConfigResponse.kInterfaceName, android.hardware.radio.config.V1_0.IRadioConfigResponse.kInterfaceName, "android.hidl.base@1.0::IBase"}));
        }

        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-55, -83, 24, 114, -110, 104, 89, 61, 20, 104, 29, -120, -1, -83, 28, -105, -25, 7, 68, 74, 69, -31, -76, -19, Byte.MIN_VALUE, 77, -85, -108, -98, -37, -40, 79}, new byte[]{-40, -25, 113, 126, -127, -121, -35, 116, 83, -44, 20, Const.Command.SET_LISTEN_CMD, -113, Const.Command.SET_OFFLINE_MODE_CMD, 30, 124, Const.Command.QUERY_SIGNAL_STRENGTH_CMD, 94, 122, 111, -98, -115, 68, -84, 13, 82, -77, -66, 80, Const.Command.QUERY_DIGITAL_AUDIO_RECEIVE_INFO, -2, -125}, new byte[]{-76, Const.Command.SET_VOL_CMD, -77, -69, -43, -25, -75, 25, -30, -125, 98, Const.Command.QUERY_VERSION_CMD, 12, Const.Command.SET_DIGITAL_INFO_CMD, 5, Const.Command.MODULE_INIT_CMD, 117, Const.Command.INTERRUPT_TRANSMIT_CMD, 109, -26, -77, 15, 79, -48, -98, -62, -22, 120, 79, Const.Command.QUERY_ANALOG_INFO_CMD, 10, -80}, new byte[]{-94, -23, -73, Const.Command.MODULE_INIT_CMD, 9, -9, -108, Const.Command.SET_LAUNCH_INFO_CMD, -9, 101, -125, -127, 116, -32, 75, 111, -102, 62, 108, -117, 118, -71, Const.Command.SET_ANALOG_INFO_CMD, -4, 23, 5, 99, Const.Command.SET_DIGITAL_INFO_CMD, 7, -70, -44, 75}, new byte[]{-20, ByteCompanionObject.MAX_VALUE, -41, -98, -48, Const.Command.RECEIVE_SMS_CMD, -6, -123, -68, 73, -108, Const.Command.SET_LAUNCH_INFO_CMD, -83, -82, 62, -66, Const.Command.SET_ANALOG_INFO_CMD, -17, 5, Const.Command.QUERY_DIGITAL_INFO_CMD, -13, -51, 105, 87, 19, -109, Const.Command.QUERY_DIGITAL_INFO_CMD, -72, 59, 24, -54, 76}}));
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 2:
                    ...
                    return;
                case 3:
                    hwParcel.enforceInterface(android.hardware.radio.config.V1_1.IRadioConfigResponse.kInterfaceName);
                ...
                case 6:
                    ...
                    return;
                case 7:
                    hwParcel.enforceInterface(android.hardware.radio.config.V1_2.IRadioConfigResponse.kInterfaceName);
