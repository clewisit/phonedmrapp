...
public interface IRadioConfig extends android.hardware.radio.config.V1_1.IRadioConfig {
    ...
    public static final class Proxy implements IRadioConfig {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of android.hardware.radio.config@1.3::IRadioConfig]@Proxy";
            }
        }
        ...
        public void setResponseFunctions(IRadioConfigResponse iRadioConfigResponse, IRadioConfigIndication iRadioConfigIndication) throws RemoteException {
            ...
            hwParcel.writeInterfaceToken(android.hardware.radio.config.V1_0.IRadioConfig.kInterfaceName);
        ...
        public void getPhoneCapability(int i) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.radio.config.V1_1.IRadioConfig.kInterfaceName);
            hwParcel.writeInt32(i);
            HwParcel hwParcel2 = new HwParcel();
            try {
        ...
        public void getModemsConfig(int i) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.radio.config.V1_1.IRadioConfig.kInterfaceName);
            hwParcel.writeInt32(i);
            HwParcel hwParcel2 = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IRadioConfig {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IRadioConfig.kInterfaceName, android.hardware.radio.config.V1_1.IRadioConfig.kInterfaceName, android.hardware.radio.config.V1_0.IRadioConfig.kInterfaceName, "android.hidl.base@1.0::IBase"}));
        }

        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-14, Const.Command.SET_ENHANCE_FUNCTION_CMD, 19, 97, 91, -31, 68, 93, -35, -127, 118, 85, -64, 84, -4, 105, -36, -98, -2, -91, 108, -112, Const.Command.INTERRUPT_TRANSMIT_CMD, -51, 7, 87, -13, -53, -19, 25, 6, 65}, new byte[]{81, -26, -106, -64, -50, -1, 48, -9, 77, -88, -1, -115, 2, -2, 69, Const.Command.SET_DIGITAL_INFO_CMD, -1, -46, -12, -96, 76, -33, -37, -54, 12, 104, -65, -90, 79, -51, 48, 107}, new byte[]{-121, Const.Command.SET_MIX_CHECK_INFO_CMD, 84, 105, -49, 68, 9, -16, -13, 59, 1, 80, -114, 122, 71, 124, -9, 31, Const.Command.SET_GAIN_MIC_CMD, 17, -28, 102, -35, 126, Const.Command.SET_SMS_PROTOCOL_TYPE_CMD, -75, -105, 26, 27, Const.Command.MODULE_INIT_CMD, -89, Const.Command.QUERY_DIGITAL_AUDIO_RECEIVE_INFO}, new byte[]{-20, ByteCompanionObject.MAX_VALUE, -41, -98, -48, Const.Command.RECEIVE_SMS_CMD, -6, -123, -68, 73, -108, Const.Command.SET_LAUNCH_INFO_CMD, -83, -82, 62, -66, Const.Command.SET_ANALOG_INFO_CMD, -17, 5, Const.Command.QUERY_DIGITAL_INFO_CMD, -13, -51, 105, 87, 19, -109, Const.Command.QUERY_DIGITAL_INFO_CMD, -72, 59, 24, -54, 76}}));
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.radio.config.V1_0.IRadioConfig.kInterfaceName);
                ...
                case 3:
                    ...
                    return;
                case 4:
                    hwParcel.enforceInterface(android.hardware.radio.config.V1_1.IRadioConfig.kInterfaceName);
                    getPhoneCapability(hwParcel.readInt32());
                    return;
                case 5:
                    hwParcel.enforceInterface(android.hardware.radio.config.V1_1.IRadioConfig.kInterfaceName);
                    setPreferredDataModem(hwParcel.readInt32(), hwParcel.readInt8());
                    return;
                case 6:
                    hwParcel.enforceInterface(android.hardware.radio.config.V1_1.IRadioConfig.kInterfaceName);
                    ...
                    setModemsConfig(readInt32, modemsConfig);
                    return;
                case 7:
                    hwParcel.enforceInterface(android.hardware.radio.config.V1_1.IRadioConfig.kInterfaceName);
                    getModemsConfig(hwParcel.readInt32());
                    return;
                case 8:
                    hwParcel.enforceInterface(IRadioConfig.kInterfaceName);
                    getHalDeviceCapabilities(hwParcel.readInt32());
                    return;
                default:
                    switch (i) {
                        case 256067662:
