...
public interface IOemHookResponse extends IBase {
    ...
    static IOemHookResponse asInterface(IHwBinder iHwBinder) {
        ...
        IOemHookResponse queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof IOemHookResponse)) {
    ...
    public static abstract class Stub extends HwBinder implements IOemHookResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IOemHookResponse.kInterfaceName, "android.hidl.base@1.0::IBase"}));
        }

        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{111, -44, -121, 79, 14, -35, -44, 98, 106, Const.Command.QUERY_INIT_STATUS_CMD, 101, -113, -39, 79, -83, 82, 108, Const.Command.SET_POWER_SAVE_MODE_CMD, ByteCompanionObject.MAX_VALUE, Const.Command.INTERRUPT_TRANSMIT_CMD, 99, 67, -98, 121, 113, -117, -37, 26, Const.Command.SET_SMS_PROTOCOL_TYPE_CMD, Const.Command.SET_ANALOG_INFO_CMD, 9, -43}, new byte[]{-20, ByteCompanionObject.MAX_VALUE, -41, -98, -48, Const.Command.RECEIVE_SMS_CMD, -6, -123, -68, 73, -108, Const.Command.SET_LAUNCH_INFO_CMD, -83, -82, 62, -66, Const.Command.SET_ANALOG_INFO_CMD, -17, 5, Const.Command.QUERY_DIGITAL_INFO_CMD, -13, -51, 105, 87, 19, -109, Const.Command.QUERY_DIGITAL_INFO_CMD, -72, 59, 24, -54, 76}}));
        }
