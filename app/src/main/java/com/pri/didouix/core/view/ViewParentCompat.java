package com.pri.didouix.core.view;
...
import com.pri.didoui.core.view.NestedScrollingParent2;
import com.pri.didoui.core.view.NestedScrollingParent3;
...
public final class ViewParentCompat {
    ...
    public static void onNestedScroll(ViewParent viewParent, @NonNull View view, int i, int i2, int i3, int i4) {
        onNestedScroll(viewParent, view, i, i2, i3, i4, 0, getTempNestedScrollConsumed());
    }

    public static void onNestedScroll(ViewParent viewParent, @NonNull View view, int i, int i2, int i3, int i4, int i5) {
        onNestedScroll(viewParent, view, i, i2, i3, i4, i5, getTempNestedScrollConsumed());
    }

    public static void onNestedPreScroll(ViewParent viewParent, View view, int i, int i2, @NonNull int[] iArr) {
    ...
    public static void onNestedPreScroll(ViewParent viewParent, View view, int i, int i2, @NonNull int[] iArr, int i3) {
        if (viewParent instanceof NestedScrollingParent2) {
