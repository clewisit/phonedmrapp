...
public class PrizeSpringBackLayout extends SpringBackLayout {
    ...
    @Override // com.pri.didouix.springback.view.SpringBackLayout, android.view.ViewGroup
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        } else if (action == 2 && (recyclerView = this.mRecyclerView) != null && this.mCurrentTabSelected && recyclerView.getChildAdapterPosition(recyclerView.findChildViewUnder(x, y)) >= 0) {
            return false;
        } else {
            return onInterceptTouchEvent;
        }
