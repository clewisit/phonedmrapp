...
public class FragmentLocalTestBiteErrorRateActivity extends AppCompatActivity implements DmrManager.MessageListener {
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        setContentView((int) R.layout.fragment_local_test_bite_error_rate_activity);
        ...
        testBiteErrorRateMessage.protocol = 2;
    ...
    public void dealEvent(BaseMessage baseMessage) {
        if (baseMessage.packet != null) {
            ...
            runOnUiThread(new FragmentLocalTestBiteErrorRateActivity$$ExternalSyntheticLambda0(this));
        }
    }
