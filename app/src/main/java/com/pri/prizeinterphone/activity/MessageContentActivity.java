...
public class MessageContentActivity extends AppCompatActivity implements View.OnClickListener, MessageLisenter {
    ...
    private ArrayList<MessageData> mMessageListData;
    private Drawable mRecieveIconDrawable;
    private Drawable mSendIconDrawable;
    private Toast mToast;
    private TextView mTvTitle;
    private int mConvType = -1;
    private int mConvTarget = -1;
    private boolean isEdit = false;
    Runnable freshSendBtnRunn = new Runnable() { // from class: com.pri.prizeinterphone.activity.MessageContentActivity.2
        @Override // java.lang.Runnable
        public void run() {
            MessageContentActivity.this.freshSendButton(true);
        }
    };
    public Handler mHandler = new Handler() { // from class: com.pri.prizeinterphone.activity.MessageContentActivity.5
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.interphone_message_activity);
        initView();
        initData();
    ...
    public void initView() {
        ...
        this.mListView.setOnScrollListener(new AbsListView.OnScrollListener() { // from class: com.pri.prizeinterphone.activity.MessageContentActivity.1
    ...
    public void initData() {
        ...
        reFreshListUI();
        Bitmap imgData = PersonSharePrefData.getImgData(this, "pref_person_icon", null);
        if (imgData == null) {
    ...
    private void copy() {
        ((ClipboardManager) getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText(null, this.mMessageListData.get(this.mCurrentPosition).getContent()));
    }
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.back_button) {
            ...
            if (this.mEdit.getText().toString().isEmpty() || isTalkSend()) {
                return;
            }
            saveAndSendMsg();
            this.mEdit.setText("");
            freshSendButton(false);
            this.mHandler.postDelayed(this.freshSendBtnRunn, 3500L);
        } else {
            switch (id) {
    ...
    public void onMessageReceived() {
        ...
        this.mHandler.post(new Runnable() { // from class: com.pri.prizeinterphone.activity.MessageContentActivity.3
            @Override // java.lang.Runnable
            public void run() {
                MessageContentActivity.this.reFreshUI();
            }
    ...
    public void onMessageSend(final MessageData messageData) {
        ...
        this.mHandler.post(new Runnable() { // from class: com.pri.prizeinterphone.activity.MessageContentActivity.4
            @Override // java.lang.Runnable
            public void run() {
    ...
    public class MessageListAdapter extends BaseAdapter {
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            ...
            viewHolder3.mTvValues.setOnClickListener(new View.OnClickListener() { // from class: com.pri.prizeinterphone.activity.MessageContentActivity.MessageListAdapter.1
                @Override // android.view.View.OnClickListener
