...
public final class Packet {
    ...
    public String toString() {
        return "Packet{head=" + Integer.toHexString(this.head & UByte.MAX_VALUE) + ", cmd=" + Integer.toHexString(this.cmd & UByte.MAX_VALUE) + "(" + cmd2Str(this.cmd) + "), rw=" + Integer.toHexString(this.rw & UByte.MAX_VALUE) + ", sr=" + Integer.toHexString(this.sr & UByte.MAX_VALUE) + ", ckSum=" + Integer.toHexString(this.ckSum & UShort.MAX_VALUE) + ", len=" + this.len + ", body=" + Arrays.toString(this.body) + ", tail=" + Integer.toHexString(16) + '}';
    }
}
