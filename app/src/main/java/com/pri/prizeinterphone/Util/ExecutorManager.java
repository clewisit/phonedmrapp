...
public final class ExecutorManager {
    ...
    public ThreadPoolExecutor getWriteThread() {
        ...
        if (threadPoolExecutor == null || threadPoolExecutor.isShutdown()) {
            this.writeThread = new ThreadPoolExecutor(1, 1, 0, TimeUnit.MILLISECONDS, new LinkedBlockingQueue(100), new NamedThreadFactory(WRITE_THREAD_NAME), new RejectedHandler());
        }
    ...
    public ThreadPoolExecutor getDispatchThread() {
        ...
        if (threadPoolExecutor == null || threadPoolExecutor.isShutdown()) {
            this.dispatchThread = new ThreadPoolExecutor(2, 4, 1, TimeUnit.SECONDS, new LinkedBlockingQueue(100), new NamedThreadFactory(DISPATCH_THREAD_NAME), new RejectedHandler());
        }
