...
public class UtilContactsData {
    ...
    public ContactData queryData(String str) {
        SQLiteDatabase writableDatabase = this.mHelper.getWritableDatabase();
        this.mDB = writableDatabase;
        Cursor query = writableDatabase.query(this.mDBName, (String[]) null, "person_id=?", new String[]{str}, (String) null, (String) null, (String) null);
        Bitmap bitmap = null;
    ...
    public boolean queryData(ContactData contactData, ContactData contactData2) {
        SQLiteDatabase writableDatabase = this.mHelper.getWritableDatabase();
        this.mDB = writableDatabase;
        Cursor query = writableDatabase.query(this.mDBName, new String[]{TABLE_ID, TABLE_NAME}, "person_id=?", new String[]{contactData.getId()}, (String) null, (String) null, (String) null);
        if (query.moveToFirst()) {
            Log.e("peisaisai", "cursor has data!");
            String string = query.getString(query.getColumnIndex(TABLE_ID));
            String string2 = query.getString(query.getColumnIndex(TABLE_NAME));
        ...
        Cursor query2 = this.mDB.query(this.mDBName, new String[]{TABLE_ID, TABLE_NAME}, "person_name=?", new String[]{contactData.getName()}, (String) null, (String) null, (String) null);
