...
public class CmdStateMachine extends StateMachine {
    ...
    private AppFirstEnterState mAppFirstEnterState;
    private ArraySet<IState> mDealStateList;
    private InitializedFeedBack mInitializedFeedBack;
    private NoDealState mNoDealState;
    private SetChannelState mSetChannelState;
    private boolean setChannelAgainAlreadyForFail;
    ...
    protected CmdStateMachine(String str) {
        super(str);
        this.mDealStateList = new ArraySet<>();
        this.mNoDealState = new NoDealState();
        this.mAppFirstEnterState = new AppFirstEnterState();
        this.mSetChannelState = new SetChannelState();
    ...
    public void getCmdResultFromModule(BaseMessage baseMessage) {
        if (baseMessage == null) {
            ...
            Log.d(TAG, "getCmdResultFromModule,cmd=" + String.format("%02x", Byte.valueOf(baseMessage.packet.cmd)));
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                case 5:
                    ...
                    CmdStateMachine.this.sendMessageDelayed(13, channelData.type != 0 ? 35 : 34, 1000L);
                ...
                case 6:
                    ...
                    CmdStateMachine.this.sendMessageDelayed(13, channelData2.type != 0 ? 35 : 34, 1000L);
                    DmrManager.getInstance().sendSetMicGainCmdToMdl();
                    return true;
                case 7:
                case 8:
                    CmdStateMachine cmdStateMachine2 = CmdStateMachine.this;
                    cmdStateMachine2.transitionTo(cmdStateMachine2.mNoDealState);
                    return true;
                case 9:
                default:
                    return true;
                case 10:
                    ...
                    CmdStateMachine.this.sendMessageDelayed(12, 1000L);
                    return true;
                case 11:
                    DmrManager.getInstance().sendSetChannelCmdToMdl(this.tmpChannelData);
                    CmdStateMachine.this.sendMessageDelayed(12, 1000L);
                ...
                case 12:
                    ...
                    if (channelData3 == null) {
                        ...
                        if (currentChannel != null) {
                            CmdStateMachine.this.sendMessageDelayed(13, currentChannel.type != 0 ? 35 : 34, 1000L);
                            return true;
                        }
                        Log.e(CmdStateMachine.TAG, "set currentChannel is null");
                        CmdStateMachine cmdStateMachine3 = CmdStateMachine.this;
                        cmdStateMachine3.transitionTo(cmdStateMachine3.mNoDealState);
                        return true;
                    }
                    CmdStateMachine.this.sendMessageDelayed(13, channelData3.type != 0 ? 35 : 34, 1000L);
                    return true;
                case 13:
                    byte b = (byte) message.arg1;
                    Log.d(CmdStateMachine.TAG, "MSG_SET_CHANNEL_ERROR,cmd" + ((int) b));
    ...
    public void setChannelData(ChannelData channelData) {
        if (channelData != null) {
            try {
                this.mSetChannelState.setChannelData(channelData.m1325clone());
                return;
            } catch (CloneNotSupportedException e) {
                Log.d(TAG, "setChannelData error", e);
                this.mSetChannelState.setChannelData(null);
                return;
            }
        }
        this.mSetChannelState.setChannelData(null);
