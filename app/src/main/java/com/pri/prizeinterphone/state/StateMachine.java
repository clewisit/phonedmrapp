...
public class StateMachine {
    ...
    public static class SmHandler extends Handler {
        ...
        public void removeState(State state) {
            ...
            if (stateInfo == null || stateInfo.active || this.mStateInfo.values().stream().filter(new Predicate() { // from class: com.pri.prizeinterphone.state.StateMachine$SmHandler$$ExternalSyntheticLambda0
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    boolean lambda$removeState$0;
                    return false; // TODO: JADX lambda error
                }
            }).findAny().isPresent()) {
                return;
            }
        ...
        public boolean isStart() {
            return this.mIsConstructionCompleted;
        }
    }
