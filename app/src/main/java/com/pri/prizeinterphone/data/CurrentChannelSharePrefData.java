...
public class CurrentChannelSharePrefData {
    ...
    public static void putIntData(Context context, String str, int i) {
        SharedPreferences.Editor edit = InterPhoneApplication.getContext().getSharedPreferences("com.pri.prizeinterphone.data.currentchannel", 0).edit();
        edit.putInt(str, i);
        edit.commit();
    }

    public static int getIntData(Context context, String str, int i) {
        return InterPhoneApplication.getContext().getSharedPreferences("com.pri.prizeinterphone.data.currentchannel", 0).getInt(str, i);
    }
    ...
    public static String getStringData(Context context, String str, String str2) {
        return InterPhoneApplication.getContext().getSharedPreferences("com.pri.prizeinterphone.data.currentchannel", 0).getString(str, str2);
    }
    ...
    public static boolean getBooleanData(Context context, String str, boolean z) {
        return InterPhoneApplication.getContext().getSharedPreferences("com.pri.prizeinterphone.data.currentchannel", 0).getBoolean(str, z);
    }
}
