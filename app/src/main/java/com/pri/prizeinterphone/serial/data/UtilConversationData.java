...
public class UtilConversationData {
    ...
    public ConversationData getConversation(int i, int i2) {
        ...
        String str = this.mDBName;
        Cursor query = writableDatabase.query(str, null, "conver_type=? AND conver_target=?", new String[]{i + "", i2 + ""}, null, null, null, "1");
    ...
    public ArrayList<ConversationData> getAllConversations() {
        ...
        Cursor query = this.mDB.query(this.mDBName, null, null, null, null, null, "conver_timestamp desc");
        while (query.moveToNext()) {
