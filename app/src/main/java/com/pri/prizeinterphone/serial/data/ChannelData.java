...
public class ChannelData implements Parcelable, Cloneable {
    public static final Parcelable.Creator<ChannelData> CREATOR = new Parcelable.Creator<ChannelData>() { // from class: com.pri.prizeinterphone.serial.data.ChannelData.1
    ...
    @NonNull
    /* renamed from: clone */
    public ChannelData m1325clone() throws CloneNotSupportedException {
