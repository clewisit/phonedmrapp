...
public class UtilRecordData {
    ...
    public ArrayList<AudioRecordData> getAllRecordFiles() {
        ...
        Cursor query = this.mDB.query(this.mDBNameDefault, (String[]) null, (String) null, (String[]) null, (String) null, (String) null, "record_timestamp desc");
        while (query.moveToNext()) {
            ...
            arrayList.add(new AudioRecordData((long) i, string, string2, valueOf.longValue(), query.getInt(query.getColumnIndex(TABLE_DIRECTION)), string3));
        }
        return arrayList;
    }
    ...
    public long addRecordData(AudioRecordData audioRecordData) {
        ...
        return this.mDB.insert(this.mDBNameDefault, (String) null, contentValues);
    }
