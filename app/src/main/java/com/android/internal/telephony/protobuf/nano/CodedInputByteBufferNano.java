...
public final class CodedInputByteBufferNano {
    ...
    public void skipMessage() throws java.io.IOException {
        ...
        L_0x000c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.protobuf.nano.CodedInputByteBufferNano.skipMessage():void");
    }
    ...
    public int readRawVarint32() throws IOException {
        ...
        byte b = readRawByte & ByteCompanionObject.MAX_VALUE;
        byte readRawByte2 = readRawByte();
        if (readRawByte2 >= 0) {
            i = readRawByte2 << 7;
        } else {
            b |= (readRawByte2 & ByteCompanionObject.MAX_VALUE) << 7;
            byte readRawByte3 = readRawByte();
            if (readRawByte3 >= 0) {
                i = readRawByte3 << 14;
            } else {
                b |= (readRawByte3 & ByteCompanionObject.MAX_VALUE) << 14;
                byte readRawByte4 = readRawByte();
                if (readRawByte4 >= 0) {
                    i = readRawByte4 << 21;
                } else {
                    byte b2 = b | ((readRawByte4 & ByteCompanionObject.MAX_VALUE) << 21);
    ...
    public int readRawLittleEndian32() throws IOException {
        ...
        byte readRawByte2 = readRawByte();
        byte readRawByte3 = readRawByte();
        return ((readRawByte() & UByte.MAX_VALUE) << 24) | (readRawByte & UByte.MAX_VALUE) | ((readRawByte2 & UByte.MAX_VALUE) << 8) | ((readRawByte3 & UByte.MAX_VALUE) << 16);
    }
