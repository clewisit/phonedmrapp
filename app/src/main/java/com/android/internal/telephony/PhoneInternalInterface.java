...
public interface PhoneInternalInterface {
    ...
    void setRadioPowerForReason(boolean z, boolean z2, boolean z3, boolean z4, int i) {
    }

    void setRadioPowerOnForTestEmergencyCall(boolean z) {
    }
    ...
    void updateServiceLocation(WorkSource workSource) {
    }
    ...
    Connection dial(String str, DialArgs dialArgs) throws CallStateException {
        return dial(str, dialArgs, new PhoneInternalInterface$$ExternalSyntheticLambda0());
    }
    ...
    void setRadioPower(boolean z, boolean z2, boolean z3, boolean z4) {
        setRadioPowerForReason(z, z2, z3, z4, 0);
    }

    void setRadioPowerForReason(boolean z, int i) {
