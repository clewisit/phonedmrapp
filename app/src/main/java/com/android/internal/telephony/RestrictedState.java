...
public class RestrictedState {
    ...
    public boolean equals(Object obj) {
        try {
            ...
            if (obj != null && this.mPsRestricted == restrictedState.mPsRestricted && this.mCsNormalRestricted == restrictedState.mCsNormalRestricted && this.mCsEmergencyRestricted == restrictedState.mCsEmergencyRestricted) {
                return true;
            }
            return false;
