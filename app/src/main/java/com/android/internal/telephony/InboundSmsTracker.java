...
public class InboundSmsTracker {
    ...
    public InboundSmsTracker(Context context, byte[] bArr, long j, int i, boolean z, String str, String str2, int i2, int i3, int i4, boolean z2, String str3, boolean z3, int i5, int i6) {
        ...
        this.mMessageId = createMessageId(context, j, i7);
        this.mSmsSource = i6;
    }
    ...
    public ContentValues getContentValues() {
        ...
        int i2 = (i == -1 ? 65536 : i & 65535) | (this.mIs3gpp2 ? 262144 : 131072);
    ...
    public Pair<String, String[]> getExactMatchDupDetectQuery() {
        ...
        String num = Integer.toString(getReferenceNumber());
        String num2 = Integer.toString(getMessageCount());
        String num3 = Integer.toString(getSequenceNumber());
        String l = Long.toString(getTimestamp());
        String messageBody = getMessageBody();
        return new Pair<>(addDestPortQuery("address=? AND reference_number=? AND count=? AND sequence=? AND date=? AND message_body=?"), new String[]{address, num, num2, num3, l, messageBody});
    }
    ...
    public Pair<String, String[]> getInexactMatchDupDetectQuery() {
        ...
        String num2 = Integer.toString(getMessageCount());
        String num3 = Integer.toString(getSequenceNumber());
        return new Pair<>(addDestPortQuery("address=? AND reference_number=? AND count=? AND sequence=? AND deleted=0"), new String[]{address, num, num2, num3});
    }
