...
public class RadioIndication extends IRadioIndication.Stub {
    ...
    public void newSms(int i, ArrayList<Byte> arrayList) {
        ...
        com.android.internal.telephony.gsm.SmsMessage createFromPdu = com.android.internal.telephony.gsm.SmsMessage.createFromPdu(arrayListToPrimitiveArray);
    ...
    public void currentSignalStrength(int i, SignalStrength signalStrength) {
        this.mRil.processIndication(0, i);
        android.telephony.SignalStrength fixupSignalStrength10 = this.mRil.fixupSignalStrength10(RILUtils.convertHalSignalStrength((Object) signalStrength));
    ...
    public void currentLinkCapacityEstimate(int i, LinkCapacityEstimate linkCapacityEstimate) {
        this.mRil.processIndication(0, i);
        List<android.telephony.LinkCapacityEstimate> convertHalLceData = RILUtils.convertHalLceData((Object) linkCapacityEstimate);
    ...
    public void stkCallSetup(int i, long j) {
        this.mRil.processIndication(0, i);
        this.mRil.unsljLogRet(PointerIconCompat.TYPE_VERTICAL_DOUBLE_ARROW, Long.valueOf(j));
    ...
    public void callRing(int i, boolean z, CdmaSignalInfoRecord cdmaSignalInfoRecord) {
        ...
        this.mRil.processIndication(0, i);
        if (!z) {
            cArr = new char[]{cdmaSignalInfoRecord.isPresent ? (char) 1 : 0, (char) cdmaSignalInfoRecord.signalType, (char) cdmaSignalInfoRecord.alertPitch, (char) cdmaSignalInfoRecord.signal};
            this.mRil.writeMetricsCallRing(cArr);
        } else {
            cArr = null;
        }
        this.mRil.unsljLogRet(PointerIconCompat.TYPE_ZOOM_IN, cArr);
    ...
    public void newBroadcastSms(int i, ArrayList<Byte> arrayList) {
        this.mRil.processIndication(0, i);
        byte[] arrayListToPrimitiveArray = RILUtils.arrayListToPrimitiveArray(arrayList);
        this.mRil.unsljLogvRet(PointerIconCompat.TYPE_GRABBING, IccUtils.bytesToHexString(arrayListToPrimitiveArray));
    ...
    public void cdmaCallWaiting(int i, CdmaCallWaiting cdmaCallWaiting) {
        ...
        this.mRil.unsljLogRet(InputDeviceCompat.SOURCE_GAMEPAD, cdmaCallWaitingNotification);
    ...
    public void onSupplementaryServiceIndication(int i, StkCcUnsolSsResult stkCcUnsolSsResult) {
        ...
        if (!ssData.serviceType.isTypeCF() || !ssData.requestType.isTypeInterrogation()) {
            ...
            int size = ssInfoData.ssInfo.size();
            ssData.ssInfo = new int[size];
            while (i2 < size) {
                ssData.ssInfo[i2] = ((Integer) ssInfoData.ssInfo.get(i2)).intValue();
                RIL ril = this.mRil;
                ril.riljLog("[SS Data] SS Info " + i2 + " : " + ssData.ssInfo[i2]);
                i2++;
            }
        } else {
            CfData cfData = (CfData) stkCcUnsolSsResult.cfData.get(0);
            int size2 = cfData.cfInfo.size();
            ssData.cfInfo = new CallForwardInfo[size2];
            while (i2 < size2) {
                CallForwardInfo callForwardInfo = (CallForwardInfo) cfData.cfInfo.get(i2);
    ...
    public void lceData(int i, LceDataInfo lceDataInfo) {
        this.mRil.processIndication(0, i);
        List<android.telephony.LinkCapacityEstimate> convertHalLceData = RILUtils.convertHalLceData((Object) lceDataInfo);
        this.mRil.unsljLogRet(1045, convertHalLceData);
        RegistrantList registrantList = this.mRil.mLceInfoRegistrants;
        if (registrantList != null) {
            registrantList.notifyRegistrants(new AsyncResult((Object) null, convertHalLceData, (Throwable) null));
    ...
    public void simPhonebookRecordsReceived(int i, byte b, ArrayList<PhonebookRecordInfo> arrayList) {
        ...
        RIL ril = this.mRil;
        ril.unsljLogRet(1054, "status = " + b + " received " + arrayList.size() + " records");
    ...
    public void registrationFailed(int i, CellIdentity cellIdentity, String str, int i2, int i3, int i4) {
        this.mRil.processIndication(0, i);
        android.telephony.CellIdentity convertHalCellIdentity = RILUtils.convertHalCellIdentity((Object) cellIdentity);
    ...
    public void barringInfoChanged(int i, CellIdentity cellIdentity, ArrayList<BarringInfo> arrayList) {
        ...
        this.mRil.mBarringInfoChangedRegistrants.notifyRegistrants(new AsyncResult((Object) null, new android.telephony.BarringInfo(RILUtils.convertHalCellIdentity((Object) cellIdentity), RILUtils.convertHalBarringInfoList((List<BarringInfo>) arrayList)), (Throwable) null));
    }
    ...
    private void setFrequencyRangeOrChannelNumber(PhysicalChannelConfig.Builder builder, android.hardware.radio.V1_4.PhysicalChannelConfig physicalChannelConfig) {
        ...
        if (discriminator == 0) {
            ...
            RIL ril = this.mRil;
            ril.riljLoge("Unsupported frequency type " + physicalChannelConfig.rfInfo.getDiscriminator());
        } else {
    ...
    private void physicalChannelConfigsIndication(List<? extends Object> list) {
        ...
        try {
            for (android.hardware.radio.V1_2.PhysicalChannelConfig next : list) {
                if (next instanceof android.hardware.radio.V1_2.PhysicalChannelConfig) {
                    android.hardware.radio.V1_2.PhysicalChannelConfig physicalChannelConfig = next;
                ...
                } else if (next instanceof android.hardware.radio.V1_4.PhysicalChannelConfig) {
                    android.hardware.radio.V1_4.PhysicalChannelConfig physicalChannelConfig2 = (android.hardware.radio.V1_4.PhysicalChannelConfig) next;
                    ...
                    arrayList.add(builder.setCellConnectionStatus(RILUtils.convertHalCellConnectionStatus(physicalChannelConfig2.base.status)).setCellBandwidthDownlinkKhz(physicalChannelConfig2.base.cellBandwidthDownlink).setNetworkType(ServiceState.rilRadioTechnologyToNetworkType(physicalChannelConfig2.rat)).setPhysicalCellId(physicalChannelConfig2.physicalCellId).setContextIds(physicalChannelConfig2.contextIds.stream().mapToInt(new RadioIndication$$ExternalSyntheticLambda0()).toArray()).build());
                } else if (next instanceof android.hardware.radio.V1_6.PhysicalChannelConfig) {
                    android.hardware.radio.V1_6.PhysicalChannelConfig physicalChannelConfig3 = (android.hardware.radio.V1_6.PhysicalChannelConfig) next;
    ...
    private void responseNetworkScan(int i, NetworkScanResult networkScanResult) {
        this.mRil.processIndication(0, i);
        NetworkScanResult networkScanResult2 = new NetworkScanResult(networkScanResult.status, networkScanResult.error, RILUtils.convertHalCellInfoList((ArrayList<Object>) new ArrayList(networkScanResult.networkInfos)));
    ...
    private void responseDataCallListChanged(int i, List<?> list) {
        this.mRil.processIndication(0, i);
        this.mRil.unsljLogRet(PointerIconCompat.TYPE_ALIAS, list);
