...
public class CountryCodeToRegionCodeMap {
    static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList48.add("MA");
        arrayList48.add("EH");
        hashMap.put(Integer.valueOf(CommandsInterface.GSM_SMS_FAIL_CAUSE_USIM_APP_TOOLKIT_BUSY), arrayList48);
        ArrayList arrayList49 = new ArrayList(1);
        arrayList49.add("DZ");
        hashMap.put(Integer.valueOf(CommandsInterface.GSM_SMS_FAIL_CAUSE_USIM_DATA_DOWNLOAD_ERROR), arrayList49);
        ...
        arrayList53.add("SN");
        hashMap.put(Integer.valueOf(NetworkStackConstants.VENDOR_SPECIFIC_IE_ID), arrayList53);
        ...
        arrayList73.add("GA");
        hashMap.put(Integer.valueOf(CallFailCause.FDN_BLOCKED), arrayList73);
        ArrayList arrayList74 = new ArrayList(1);
        arrayList74.add("CG");
        hashMap.put(242, arrayList74);
        ArrayList arrayList75 = new ArrayList(1);
        arrayList75.add("CD");
        hashMap.put(Integer.valueOf(CallFailCause.IMEI_NOT_ACCEPTED), arrayList75);
        ArrayList arrayList76 = new ArrayList(1);
        arrayList76.add(CommandsInterface.CB_FACILITY_BAOC);
        hashMap.put(Integer.valueOf(CallFailCause.DIAL_MODIFIED_TO_USSD), arrayList76);
        ArrayList arrayList77 = new ArrayList(1);
        arrayList77.add("GW");
        hashMap.put(Integer.valueOf(CallFailCause.DIAL_MODIFIED_TO_SS), arrayList77);
        ArrayList arrayList78 = new ArrayList(1);
        arrayList78.add("IO");
        hashMap.put(Integer.valueOf(CallFailCause.DIAL_MODIFIED_TO_DIAL), arrayList78);
        ArrayList arrayList79 = new ArrayList(1);
        arrayList79.add(CommandsInterface.CB_FACILITY_BA_MT);
        hashMap.put(Integer.valueOf(CallFailCause.RADIO_OFF), arrayList79);
        ...
        arrayList83.add("ET");
        hashMap.put(Integer.valueOf(CallFailCause.NETWORK_RESP_TIMEOUT), arrayList83);
        ArrayList arrayList84 = new ArrayList(1);
        arrayList84.add("SO");
        hashMap.put(Integer.valueOf(CallFailCause.NETWORK_REJECT), arrayList84);
        ArrayList arrayList85 = new ArrayList(1);
        arrayList85.add("DJ");
        hashMap.put(Integer.valueOf(CallFailCause.RADIO_ACCESS_FAILURE), arrayList85);
        ArrayList arrayList86 = new ArrayList(1);
        arrayList86.add("KE");
        hashMap.put(Integer.valueOf(CallFailCause.RADIO_LINK_FAILURE), arrayList86);
        ...
        arrayList90.add("MZ");
        hashMap.put(Integer.valueOf(CallFailCause.RADIO_RELEASE_NORMAL), arrayList90);
        ArrayList arrayList91 = new ArrayList(1);
        arrayList91.add("ZM");
        hashMap.put(Integer.valueOf(CallFailCause.ACCESS_CLASS_BLOCKED), arrayList91);
        ArrayList arrayList92 = new ArrayList(1);
        arrayList92.add("MG");
        hashMap.put(Integer.valueOf(CallFailCause.NETWORK_DETACH), arrayList92);
        ...
        arrayList136.add("FK");
        hashMap.put(Integer.valueOf(Config.SCROLLING_FING_HORIZONTAL_HINT_DURATION), arrayList136);
        ...
        hashMap.put(Integer.valueOf(ServiceStateTracker.PS_NOTIFICATION), arrayList191);
