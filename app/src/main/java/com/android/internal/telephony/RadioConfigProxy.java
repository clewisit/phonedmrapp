...
public class RadioConfigProxy {
    private volatile IRadioConfig mAidlRadioConfigProxy = null;
    ...
    public void setHidl(HalVersion halVersion, android.hardware.radio.config.V1_0.IRadioConfig iRadioConfig) {
    ...
    public void setAidl(HalVersion halVersion, IRadioConfig iRadioConfig) {
        this.mRadioConfigHalVersion = halVersion;
    ...
    private static class RadioConfigHidlServiceDeathRecipient implements IHwBinder.DeathRecipient {
        ...
        public void setService(android.hardware.radio.config.V1_0.IRadioConfig iRadioConfig) {
