...
public interface CommandsInterface {
    ...
    void allocatePduSessionId(Message message) {
    }

    void areUiccApplicationsEnabled(Message message) {
    }

    boolean canToggleUiccApplicationsEnablement() {
        return false;
    }

    void cancelHandover(Message message, int i) {
    }
    ...
    void enableModem(boolean z, Message message) {
    }

    void enableUiccApplications(boolean z, Message message) {
    }
    ...
    void getAllowedCarriers(Message message, WorkSource workSource) {
    }
    ...
    void getBarringInfo(Message message) {
    }
    ...
    void getCellInfoList(Message message, WorkSource workSource) {
    }
    ...
    void getModemActivityInfo(Message message, WorkSource workSource) {
    }
    ...
    void getSlicingConfig(Message message) {
    }

    @UnsupportedAppUsage
    void getSmscAddress(Message message);

    void getSystemSelectionChannels(Message message) {
    }

    void getUsageSetting(Message message) {
    }
    ...
    void isNrDualConnectivityEnabled(Message message, WorkSource workSource) {
    }

    void isVoNrEnabled(Message message, WorkSource workSource) {
    }

    void nvReadItem(int i, Message message, WorkSource workSource) {
    }
    ...
    void nvWriteItem(int i, String str, Message message, WorkSource workSource) {
    }

    void onSlotActiveStatusChange(boolean z) {
    }
    ...
    void registerForBarringInfoChanged(Handler handler, int i, Object obj) {
    }
    ...
    void registerUiccApplicationEnablementChanged(Handler handler, int i, Object obj) {
    }

    void rejectCall(Message message);

    void releasePduSessionId(Message message, int i) {
    }
    ...
    void setAllowedCarriers(CarrierRestrictionRules carrierRestrictionRules, Message message, WorkSource workSource) {
    }
    ...
    void setCellInfoListRate(int i, Message message, WorkSource workSource) {
    }
    ...
    void setDataThrottling(Message message, WorkSource workSource, int i, long j) {
    }
    ...
    void setLocationUpdates(boolean z, WorkSource workSource, Message message) {
    }

    void setLogicalToPhysicalSlotMapping(int[] iArr, Message message);

    boolean setModemService(String str) {
        return true;
    }
    ...
    void setNrDualConnectivityState(int i, Message message, WorkSource workSource) {
    }
    ...
    void setOnRegistrationFailed(Handler handler, int i, Object obj) {
    }
    ...
    void setRadioPower(boolean z, boolean z2, boolean z3, Message message) {
    }

    void setSignalStrengthReportingCriteria(List<SignalThresholdInfo> list, Message message);

    void setSimCardPower(int i, Message message, WorkSource workSource) {
    }
    ...
    void setSystemSelectionChannels(List<RadioAccessSpecifier> list, Message message) {
    }
    ...
    void setUsageSetting(Message message, int i) {
    }

    void setVoNrEnabled(boolean z, Message message, WorkSource workSource) {
    }
    ...
    void startHandover(Message message, int i) {
    }
    ...
    void unSetOnRegistrationFailed(Handler handler) {
    }
    ...
    void unregisterForBarringInfoChanged(Handler handler) {
    }
    ...
    void unregisterUiccApplicationEnablementChanged(Handler handler) {
    }
