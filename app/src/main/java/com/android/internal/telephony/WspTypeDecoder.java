...
public class WspTypeDecoder {
    ...
    static {
        ...
        hashMap.put(Integer.valueOf(InputDeviceCompat.SOURCE_DPAD), "application/vnd.uplanet.cacheop-wbxml");
    ...
    public boolean decodeShortInteger(int i) {
        ...
        this.mUnsigned32bit = (long) (b & ByteCompanionObject.MAX_VALUE);
        this.mDataLength = 1;
        return true;
    }

    public boolean decodeLongInteger(int i) {
        byte b = this.mWspData[i] & UByte.MAX_VALUE;
        if (b > 30) {
            return false;
        }
        this.mUnsigned32bit = 0;
        for (int i2 = 1; i2 <= b; i2++) {
            this.mUnsigned32bit = (this.mUnsigned32bit << 8) | ((long) (this.mWspData[i + i2] & UByte.MAX_VALUE));
        }
        this.mDataLength = b + 1;
        return true;
    }
    ...
    public boolean decodeUintvarInteger(int i) {
        ...
        while (true) {
            ...
            if ((b & 128) == 0) {
                this.mUnsigned32bit = (this.mUnsigned32bit << 7) | ((long) (b & ByteCompanionObject.MAX_VALUE));
    ...
    public boolean decodeValueLength(int i) {
        byte b = this.mWspData[i];
        if ((b & UByte.MAX_VALUE) > 31) {
            return false;
        }
        if (b < 31) {
            this.mUnsigned32bit = (long) b;
            this.mDataLength = 1;
        } else {
    ...
    private boolean readContentParameters(int i, int i2, int i3) {
        ...
        if (i2 > 0) {
            ...
            if ((b & 128) == 0 && b > 31) {
                ...
                String str3 = WELL_KNOWN_PARAMETERS.get(Integer.valueOf(i6));
                if (str3 == null) {
                    str3 = "unassigned/0x" + Long.toHexString((long) i6);
                }
                if (i6 != 0) {
                    str = str3;
                } else if (!decodeUintvarInteger(i + i4)) {
                    return false;
                } else {
                    int i7 = i4 + this.mDataLength;
                    this.mContentParameters.put(str3, String.valueOf(this.mUnsigned32bit));
            ...
            if (decodeNoValue(i8)) {
                ...
                i5 = i4 + this.mDataLength;
                str2 = String.valueOf((int) this.mUnsigned32bit);
            } else {
                decodeTokenText(i8);
                i5 = i4 + this.mDataLength;
                String str4 = this.mStringValue;
                str2 = str4.startsWith("\"") ? str4.substring(1) : str4;
            }
            this.mContentParameters.put(str, str2);
