...
public abstract class Connection {
        ...
        if (callTracker != null) {
            ...
            if (phone != null) {
                ...
                if (emergencyNumberTracker != null) {
                    EmergencyNumber emergencyNumber = emergencyNumberTracker.getEmergencyNumber(this.mAddress);
    ...
    public void setNonDetectableEmergencyCallInfo(int i) {
        if (!this.mIsEmergencyCall) {
            this.mIsEmergencyCall = true;
            this.mEmergencyNumberInfo = new EmergencyNumber(this.mAddress, "", "", i, new ArrayList(), 1, 0);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:6:0x000e, code lost:
        r0 = (r0 = r2.mPostDialString).length();
        r1 = r2.mNextPostDialChar;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public java.lang.String getRemainingPostDialString() {
        /*
            r2 = this;
            com.android.internal.telephony.Connection$PostDialState r0 = r2.mPostDialState
            com.android.internal.telephony.Connection$PostDialState r1 = com.android.internal.telephony.Connection.PostDialState.CANCELLED
            if (r0 == r1) goto L_0x001e
            com.android.internal.telephony.Connection$PostDialState r1 = com.android.internal.telephony.Connection.PostDialState.COMPLETE
            if (r0 == r1) goto L_0x001e
            java.lang.String r0 = r2.mPostDialString
            if (r0 == 0) goto L_0x001e
            int r0 = r0.length()
            int r1 = r2.mNextPostDialChar
            if (r0 > r1) goto L_0x0017
            goto L_0x001e
        L_0x0017:
            java.lang.String r2 = r2.mPostDialString
        ...
        L_0x001e:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.Connection.getRemainingPostDialString():java.lang.String");
    }
    ...
    public void setConnectionCapabilities(int i) {
        if (this.mConnectionCapabilities != i) {
            ...
            for (Listener onConnectionCapabilitiesChanged : this.mListeners) {
                onConnectionCapabilitiesChanged.onConnectionCapabilitiesChanged(this.mConnectionCapabilities);
            }
        }
    }
    ...
    public void setCallRadioTech(int i) {
        if (this.mCallRadioTech != i) {
            ...
            for (Listener onCallRadioTechChanged : this.mListeners) {
                onCallRadioTechChanged.onCallRadioTechChanged(i);
            }
        }
    }
    ...
    public void notifyMediaAttributesChanged() {
        for (Listener onMediaAttributesChanged : this.mListeners) {
            onMediaAttributesChanged.onMediaAttributesChanged();
        }
    }
    ...
    public void setConnectionExtras(Bundle bundle) {
        ...
        for (Listener onExtrasChanged : this.mListeners) {
            onExtrasChanged.onExtrasChanged(this.mExtras);
        }
    }
    ...
    public void updateMultipartyState(boolean z) {
        for (Listener onMultipartyStateChanged : this.mListeners) {
            onMultipartyStateChanged.onMultipartyStateChanged(z);
        }
    }

    public void onConferenceMergeFailed() {
        for (Listener onConferenceMergedFailed : this.mListeners) {
            onConferenceMergedFailed.onConferenceMergedFailed();
        }
    }

    public void onExitedEcmMode() {
        for (Listener onExitedEcmMode : this.mListeners) {
            onExitedEcmMode.onExitedEcmMode();
        }
    }

    public void onCallPullFailed(Connection connection) {
        for (Listener onCallPullFailed : this.mListeners) {
            onCallPullFailed.onCallPullFailed(connection);
        }
    }

    public void onOriginalConnectionReplaced(Connection connection) {
        for (Listener onOriginalConnectionReplaced : this.mListeners) {
            onOriginalConnectionReplaced.onOriginalConnectionReplaced(connection);
        }
    }

    public void onHandoverToWifiFailed() {
        for (Listener onHandoverToWifiFailed : this.mListeners) {
            onHandoverToWifiFailed.onHandoverToWifiFailed();
        }
    }

    public void onConnectionEvent(String str, Bundle bundle) {
        for (Listener onConnectionEvent : this.mListeners) {
            onConnectionEvent.onConnectionEvent(str, bundle);
        }
    }

    public void onRttModifyRequestReceived() {
        for (Listener onRttModifyRequestReceived : this.mListeners) {
            onRttModifyRequestReceived.onRttModifyRequestReceived();
        }
    }

    public void onRttModifyResponseReceived(int i) {
        for (Listener onRttModifyResponseReceived : this.mListeners) {
            onRttModifyResponseReceived.onRttModifyResponseReceived(i);
        }
    }

    public void onRttInitiated() {
        for (Listener onRttInitiated : this.mListeners) {
            onRttInitiated.onRttInitiated();
        }
    }

    public void onRttTerminated() {
        for (Listener onRttTerminated : this.mListeners) {
            onRttTerminated.onRttTerminated();
        }
    }
    ...
    public void notifyDisconnect(int i) {
        ...
        for (Listener onDisconnect : this.mListeners) {
    ...
    public void setIsNetworkIdentifiedEmergencyCall(boolean z) {
        ...
        for (Listener onIsNetworkEmergencyCallChanged : this.mListeners) {
            onIsNetworkEmergencyCallChanged.onIsNetworkEmergencyCallChanged(z);
        }
    }
    ...
    public void receivedDtmfDigit(char c) {
        for (Listener onReceivedDtmfDigit : this.mListeners) {
            onReceivedDtmfDigit.onReceivedDtmfDigit(c);
        }
    }

    public void receivedRtpHeaderExtensions(Set<RtpHeaderExtension> set) {
        for (Listener onReceivedRtpHeaderExtensions : this.mListeners) {
            onReceivedRtpHeaderExtensions.onReceivedRtpHeaderExtensions(set);
        }
    }
}
