...
public class EuiccCardController extends IEuiccCardController.Stub {
    ...
    public void getAllProfiles(String str, String str2, final IGetAllProfilesCallback iGetAllProfilesCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.getAllProfiles(new AsyncResultCallback<EuiccProfileInfo[]>() {
    ...
    public void getProfile(String str, String str2, String str3, final IGetProfileCallback iGetProfileCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.getProfile(str3, new AsyncResultCallback<EuiccProfileInfo>() {
    ...
    public void getEnabledProfile(String str, String str2, int i, final IGetProfileCallback iGetProfileCallback) {
        try {
            ...
            if (!z) {
                ...
                try {
                    iGetProfileCallback.onComplete(1, (EuiccProfileInfo) null);
                } catch (RemoteException e2) {
                ...
                if (euiccPort == null && (euiccPort = getFirstActiveEuiccPort(str2)) == null) {
                    ...
                    euiccPort.getProfile(str3, new AsyncResultCallback<EuiccProfileInfo>() {
                        public void onResult(EuiccProfileInfo euiccProfileInfo) {
                            try {
                                iGetProfileCallback.onComplete(0, euiccProfileInfo);
                            } catch (RemoteException e) {
                                EuiccCardController.loge("getEnabledProfile callback failure.", e);
                            }
                        }
    ...
    public void disableProfile(String str, String str2, String str3, boolean z, final IDisableProfileCallback iDisableProfileCallback) {
        try {
            ...
            if (euiccPortFromIccId == null) {
                ...
                euiccPortFromIccId.disableProfile(str3, z, new AsyncResultCallback<Void>() {
    ...
    public void switchToProfile(String str, String str2, String str3, int i, boolean z, ISwitchToProfileCallback iSwitchToProfileCallback) {
        try {
            checkCallingPackage(str);
            EuiccPort euiccPort = getEuiccPort(str2, i);
            if (euiccPort == null) {
                ...
                final ISwitchToProfileCallback iSwitchToProfileCallback2 = iSwitchToProfileCallback;
                final EuiccPort euiccPort2 = euiccPort;
                final String str4 = str3;
                final boolean z2 = z;
                euiccPort.getProfile(str3, new AsyncResultCallback<EuiccProfileInfo>() {
                    public void onResult(final EuiccProfileInfo euiccProfileInfo) {
                        euiccPort2.switchToProfile(str4, z2, new AsyncResultCallback<Void>() {
                            public void onResult(Void voidR) {
                                try {
                                    iSwitchToProfileCallback2.onComplete(0, euiccProfileInfo);
                                } catch (RemoteException e) {
                            ...
                            public void onException(Throwable th) {
                                try {
                                    ...
                                    iSwitchToProfileCallback2.onComplete(EuiccCardController.this.getResultCode(th), euiccProfileInfo);
                                } catch (RemoteException e) {
                                    EuiccCardController.loge("switchToProfile callback failure.", e);
                                }
                            }
                    ...
                    public void onException(Throwable th) {
                        try {
                            ...
                            iSwitchToProfileCallback2.onComplete(EuiccCardController.this.getResultCode(th), (EuiccProfileInfo) null);
                        } catch (RemoteException e) {
                            EuiccCardController.loge("switchToProfile callback failure.", e);
                        }
                    }
    ...
    public void setNickname(String str, String str2, String str3, String str4, final ISetNicknameCallback iSetNicknameCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.setNickname(str3, str4, new AsyncResultCallback<Void>() {
                    public void onResult(Void voidR) {
                        try {
    ...
    public void deleteProfile(String str, final String str2, String str3, final IDeleteProfileCallback iDeleteProfileCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.deleteProfile(str3, new AsyncResultCallback<Void>() {
                    public void onResult(Void voidR) {
    ...
    public void resetMemory(String str, final String str2, int i, final IResetMemoryCallback iResetMemoryCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.resetMemory(i, new AsyncResultCallback<Void>() {
                    public void onResult(Void voidR) {
    ...
    public void getDefaultSmdpAddress(String str, String str2, final IGetDefaultSmdpAddressCallback iGetDefaultSmdpAddressCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.getDefaultSmdpAddress(new AsyncResultCallback<String>() {
                    public void onResult(String str) {
                        try {
                            iGetDefaultSmdpAddressCallback.onComplete(0, str);
                        } catch (RemoteException e) {
    ...
    public void getSmdsAddress(String str, String str2, final IGetSmdsAddressCallback iGetSmdsAddressCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.getSmdsAddress(new AsyncResultCallback<String>() {
                    public void onResult(String str) {
                        try {
                            iGetSmdsAddressCallback.onComplete(0, str);
                        } catch (RemoteException e) {
    ...
    public void setDefaultSmdpAddress(String str, String str2, String str3, final ISetDefaultSmdpAddressCallback iSetDefaultSmdpAddressCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.setDefaultSmdpAddress(str3, new AsyncResultCallback<Void>() {
                    public void onResult(Void voidR) {
                        try {
    ...
    public void getRulesAuthTable(String str, String str2, final IGetRulesAuthTableCallback iGetRulesAuthTableCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.getRulesAuthTable(new AsyncResultCallback<EuiccRulesAuthTable>() {
    ...
    public void getEuiccChallenge(String str, String str2, final IGetEuiccChallengeCallback iGetEuiccChallengeCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.getEuiccChallenge(new AsyncResultCallback<byte[]>() {
    ...
    public void getEuiccInfo1(String str, String str2, final IGetEuiccInfo1Callback iGetEuiccInfo1Callback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.getEuiccInfo1(new AsyncResultCallback<byte[]>() {
                    public void onResult(byte[] bArr) {
                        try {
    ...
    public void getEuiccInfo2(String str, String str2, final IGetEuiccInfo2Callback iGetEuiccInfo2Callback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.getEuiccInfo2(new AsyncResultCallback<byte[]>() {
                    public void onResult(byte[] bArr) {
                        try {
    ...
    public void authenticateServer(String str, String str2, String str3, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, IAuthenticateServerCallback iAuthenticateServerCallback) {
        final IAuthenticateServerCallback iAuthenticateServerCallback2 = iAuthenticateServerCallback;
        try {
            checkCallingPackage(str);
            String str4 = str2;
            EuiccPort firstActiveEuiccPort = getFirstActiveEuiccPort(str2);
            if (firstActiveEuiccPort == null) {
                try {
                    iAuthenticateServerCallback2.onComplete(-2, (byte[]) null);
                } catch (RemoteException e) {
                    loge("authenticateServer callback failure.", e);
                }
            } else {
                firstActiveEuiccPort.authenticateServer(str3, bArr, bArr2, bArr3, bArr4, new AsyncResultCallback<byte[]>() {
                    public void onResult(byte[] bArr) {
                        try {
                            iAuthenticateServerCallback2.onComplete(0, bArr);
                        } catch (RemoteException e) {
                    ...
                    public void onException(Throwable th) {
                        try {
                            ...
                            iAuthenticateServerCallback2.onComplete(EuiccCardController.this.getResultCode(th), (byte[]) null);
                        } catch (RemoteException e) {
                            EuiccCardController.loge("authenticateServer callback failure.", e);
                        }
                    }
            ...
            try {
                iAuthenticateServerCallback2.onComplete(-3, (byte[]) null);
            } catch (RemoteException e2) {
                loge("callback onComplete failure after checkCallingPackage.", e2);
            }
        }
    ...
    public void prepareDownload(String str, String str2, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, final IPrepareDownloadCallback iPrepareDownloadCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.prepareDownload(bArr, bArr2, bArr3, bArr4, new AsyncResultCallback<byte[]>() {
                    public void onResult(byte[] bArr) {
                        try {
                            iPrepareDownloadCallback.onComplete(0, bArr);
                        } catch (RemoteException e) {
    ...
    public void loadBoundProfilePackage(String str, final String str2, byte[] bArr, final ILoadBoundProfilePackageCallback iLoadBoundProfilePackageCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.loadBoundProfilePackage(bArr, new AsyncResultCallback<byte[]>() {
                    public void onResult(byte[] bArr) {
                        Log.i(EuiccCardController.TAG, "Request subscription info list refresh after install.");
                        SubscriptionController.getInstance().requestEmbeddedSubscriptionInfoListRefresh(EuiccCardController.this.mUiccController.convertToPublicCardId(str2));
                        try {
                            iLoadBoundProfilePackageCallback.onComplete(0, bArr);
                        } catch (RemoteException e) {
    ...
    public void cancelSession(String str, String str2, byte[] bArr, int i, final ICancelSessionCallback iCancelSessionCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.cancelSession(bArr, i, new AsyncResultCallback<byte[]>() {
                    public void onResult(byte[] bArr) {
                        try {
                            iCancelSessionCallback.onComplete(0, bArr);
                        } catch (RemoteException e) {
    ...
    public void listNotifications(String str, String str2, int i, final IListNotificationsCallback iListNotificationsCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.listNotifications(i, new AsyncResultCallback<EuiccNotification[]>() {
    ...
    public void retrieveNotificationList(String str, String str2, int i, final IRetrieveNotificationListCallback iRetrieveNotificationListCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.retrieveNotificationList(i, new AsyncResultCallback<EuiccNotification[]>() {
                    public void onResult(EuiccNotification[] euiccNotificationArr) {
                        try {
    ...
    public void retrieveNotification(String str, String str2, int i, final IRetrieveNotificationCallback iRetrieveNotificationCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.retrieveNotification(i, new AsyncResultCallback<EuiccNotification>() {
    ...
    public void removeNotificationFromList(String str, String str2, int i, final IRemoveNotificationFromListCallback iRemoveNotificationFromListCallback) {
        try {
            ...
            if (firstActiveEuiccPort == null) {
                ...
                firstActiveEuiccPort.removeNotificationFromList(i, new AsyncResultCallback<Void>() {
                    public void onResult(Void voidR) {
                        try {
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        EuiccCardController.super.dump(fileDescriptor, printWriter, strArr);
