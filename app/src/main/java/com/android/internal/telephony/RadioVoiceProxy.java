...
public class RadioVoiceProxy extends RadioServiceProxy {
    ...
    public void setAidl(HalVersion halVersion, IRadioVoice iRadioVoice) {
    ...
    public void emergencyDial(int i, String str, EmergencyNumber emergencyNumber, boolean z, int i2, UUSInfo uUSInfo) throws RemoteException {
        ...
        String str2 = str;
        int i3 = i2;
        UUSInfo uUSInfo2 = uUSInfo;
        if (!isEmpty() && !this.mHalVersion.less(RIL.RADIO_HAL_VERSION_1_4)) {
            if (isAidl()) {
                this.mVoiceProxy.emergencyDial(i, RILUtils.convertToHalDialAidl(str2, i3, uUSInfo2), emergencyNumber.getEmergencyServiceCategoryBitmaskInternalDial(), emergencyNumber.getEmergencyUrns() != null ? (String[]) emergencyNumber.getEmergencyUrns().stream().toArray(new RadioVoiceProxy$$ExternalSyntheticLambda0()) : new String[0], emergencyNumber.getEmergencyCallRouting(), z, emergencyNumber.getEmergencyNumberSourceBitmask() == 32);
            } else if (this.mHalVersion.greaterOrEqual(RIL.RADIO_HAL_VERSION_1_6)) {
                IRadio iRadio = this.mRadioProxy;
                Dial convertToHalDial = RILUtils.convertToHalDial(str2, i3, uUSInfo2);
                ...
                Dial convertToHalDial2 = RILUtils.convertToHalDial(str2, i3, uUSInfo2);
