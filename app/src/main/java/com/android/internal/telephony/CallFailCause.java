...
public interface CallFailCause {
    ...
    public static final int EMC_REDIAL_ON_IMS = 3001;
    public static final int EMC_REDIAL_ON_VOWIFI = 3002;
    ...
    public static final int IMS_EMERGENCY_PERM_FAILURE = 1343;
    public static final int IMS_EMERGENCY_TEMP_FAILURE = 1342;
