...
public final class MccTable {
    ...
    public static class MccMnc {
        ...
        public boolean equals(Object obj) {
            ...
            if (!this.mcc.equals(mccMnc.mcc) || !Objects.equals(this.mnc, mccMnc.mnc)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return Objects.hash(new Object[]{this.mcc, this.mnc});
        }
    ...
    public static void updateMccMncConfiguration(Context context, String str) {
        ...
        if (TelephonyUtils.IS_DEBUGGABLE) {
            ...
            if (!TextUtils.isEmpty(str2)) {
                Rlog.d(LOG_TAG, "updateMccMncConfiguration overriding mccmnc='" + str2 + "'");
                str = str2;
            }
        }
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                if (parseInt != 0) {
                    ...
                    if (!activityManager.updateMccMncConfiguration(str.substring(0, 3), str.substring(3))) {
                    ...
                    if (TextUtils.equals(getTopApp(context), "com.google.android.setupwizard.user.WelcomeActivity")) {
                        Locale localeFromMcc = LocaleUtils.getLocaleFromMcc(context, parseInt, (String) null);
                        Rlog.i(LOG_TAG, "setDeviceLocales mccLocale=" + localeFromMcc);
                        activityManager.setDeviceLocales(new LocaleList(new Locale[]{localeFromMcc}));
                        return;
                    }
                    return;
                }
    ...
    public static String getTopApp(Context context) {
        return (String) Optional.ofNullable(((ActivityManager) context.getSystemService(LaunchIdentify.HOSTTYPE_ACTIVITY)).getRunningTasks(1)).filter(new MccTable$$ExternalSyntheticLambda0()).map(new MccTable$$ExternalSyntheticLambda1()).map(new MccTable$$ExternalSyntheticLambda2()).orElse("");
    }

    /* access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$getTopApp$0(List list) {
        return list.size() > 0;
    }

    /* access modifiers changed from: private */
    public static /* synthetic */ ActivityManager.RunningTaskInfo lambda$getTopApp$1(List list) {
    ...
    static {
        ...
        sTable.add(new MccEntry(CellBroadcastStatsLog.CB_MESSAGE_FILTERED, "mt", 2));
        ...
        sTable.add(new MccEntry(366, CustomProperties.MODULE_DM, 2));
        ...
        sTable.add(new MccEntry(510, XmlTagConst.TAG_CHANNELS_ID, 2));
