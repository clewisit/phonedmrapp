...
public class KeepaliveTracker extends Handler {
    ...
    private static class KeepaliveRecord {
        ...
        KeepaliveRecord(int i, @KeepaliveStatus.KeepaliveStatusCode int i2) {
            this.slotIndex = i;
    ...
    public KeepaliveTracker(Phone phone, Looper looper, DataNetwork dataNetwork, TelephonyNetworkAgent telephonyNetworkAgent) {
        ...
        telephonyNetworkAgent.registerCallback(new TelephonyNetworkAgent.TelephonyNetworkAgentCallback(new KeepaliveTracker$$ExternalSyntheticLambda0(this)) {
    ...
    public void handleMessage(Message message) {
        ...
        if (i == 1) {
            ...
            this.mPhone.mCi.registerForNattKeepaliveStatus(this, 3, (Object) null);
        } else if (i != 5) {
    ...
    public void onStartSocketKeepaliveRequested(int i, Duration duration, KeepalivePacketData keepalivePacketData) {
        ...
        if (!(keepalivePacketData instanceof NattKeepalivePacketData)) {
            ...
            this.mPhone.mCi.startNattKeepalive(this.mDataNetwork.getId(), keepalivePacketData, (int) TimeUnit.SECONDS.toMillis(duration.getSeconds()), obtainMessage(1, i, 0, (Object) null));
        } else {
    ...
    public void onStopSocketKeepaliveRequested(int i) {
        ...
        this.mPhone.mCi.stopNattKeepalive(handleForSlot, obtainMessage(2, handleForSlot, i, (Object) null));
    }
