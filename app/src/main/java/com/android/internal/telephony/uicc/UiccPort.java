...
public class UiccPort {
    ...
    public boolean isApplicationOnIcc(IccCardApplicationStatus.AppType appType) {
        synchronized (this.mLock) {
            ...
            boolean isApplicationOnIcc = uiccProfile.isApplicationOnIcc(appType);
    ...
    public IccCardStatus.PinState getUniversalPinState() {
        synchronized (this.mLock) {
            UiccProfile uiccProfile = this.mUiccProfile;
            if (uiccProfile != null) {
                IccCardStatus.PinState universalPinState = uiccProfile.getUniversalPinState();
    ...
    public UiccCardApplication getApplication(int i) {
        synchronized (this.mLock) {
            ...
            UiccCardApplication application = uiccProfile.getApplication(i);
            return application;
        }
    }
    ...
    public UiccCardApplication getApplicationIndex(int i) {
        synchronized (this.mLock) {
            ...
            UiccCardApplication applicationIndex = uiccProfile.getApplicationIndex(i);
    ...
    public UiccCardApplication getApplicationByType(int i) {
        synchronized (this.mLock) {
            ...
            UiccCardApplication applicationByType = uiccProfile.getApplicationByType(i);
    ...
    public boolean resetAppWithAid(String str, boolean z) {
        synchronized (this.mLock) {
            ...
            boolean resetAppWithAid = uiccProfile.resetAppWithAid(str, z);
    ...
    public void iccCloseLogicalChannel(int i, Message message) {
        UiccProfile uiccProfile = this.mUiccProfile;
        if (uiccProfile != null) {
            uiccProfile.iccCloseLogicalChannel(i, message);
        } else {
    ...
    public void iccTransmitApduLogicalChannel(int i, int i2, int i3, int i4, int i5, int i6, String str, Message message) {
        UiccProfile uiccProfile = this.mUiccProfile;
        if (uiccProfile != null) {
            uiccProfile.iccTransmitApduLogicalChannel(i, i2, i3, i4, i5, i6, str, message);
        } else {
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        UiccProfile uiccProfile = this.mUiccProfile;
        if (uiccProfile != null) {
            uiccProfile.dump(fileDescriptor, printWriter, strArr);
        }
    }
    ...
    public OpenLogicalChannelRecord getOpenLogicalChannelRecord(int i) {
        synchronized (this.mOpenChannelRecords) {
            for (OpenLogicalChannelRecord next : this.mOpenChannelRecords) {
                IccLogicalChannelRequest iccLogicalChannelRequest = next.mRequest;
    ...
    public class OpenLogicalChannelRecord implements IBinder.DeathRecipient {
        ...
        public void binderDied() {
            ...
            UiccPort.this.iccCloseLogicalChannel(this.mRequest.channel, (Message) null);
