...
public final class MtkSettingsExt {
    ...
    public static final class System {
        ...
        public static final String SOUND_RECORDING_ERROR_STATUS = "sound_recording_error_status";
        ...
        public static void putInPublicSettings(Set<String> set) {
            ...
            set.add(VOICE_WAKEUP_COMMAND_STATUS_UPDATE);
            set.add(VOICE_WAKEUP_COMMAND_UI_ACTION_1ENK);
            set.add(VOICE_WAKEUP_ACTIVE_COMMAND_ID);
            set.add(VOICE_TRIGGER_MODE);
            set.add(VOICE_TRIGGER_COMMAND_STATUS);
            set.add(VOICE_TRIGGER_ACTIVE_COMMAND_ID);
            set.add(VOICE_WAKEUP_MANAGER_COMMAND_STATUS_UPDATE);
            set.add(SWITCH_RESOLUTION_BY_MODE);
            set.add(VOICE_TRAINING_RETRAIN_CALLBACK_STATUS);
        }
