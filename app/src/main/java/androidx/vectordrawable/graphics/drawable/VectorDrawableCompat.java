...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static androidx.vectordrawable.graphics.drawable.VectorDrawableCompat createWithoutDelegate(@androidx.annotation.NonNull android.content.res.Resources r6, @androidx.annotation.DrawableRes int r7, @androidx.annotation.Nullable android.content.res.Resources.Theme r8) {
        /*
