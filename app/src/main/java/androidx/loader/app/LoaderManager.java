...
public abstract class LoaderManager {
    ...
    @NonNull
    static LoaderManager getInstance(@NonNull LifecycleOwner lifecycleOwner, @NonNull ViewModelStore viewModelStore) {
        return new LoaderManagerImpl(lifecycleOwner, viewModelStore);
    }
