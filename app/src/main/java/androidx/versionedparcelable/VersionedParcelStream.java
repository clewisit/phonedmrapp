...
class VersionedParcelStream extends VersionedParcel {
    ...
    VersionedParcelStream(@Nullable InputStream inputStream, @Nullable OutputStream outputStream) {
        this(inputStream, outputStream, new SimpleArrayMap(), new SimpleArrayMap(), new SimpleArrayMap());
    }

    private VersionedParcelStream(@Nullable InputStream inputStream, @Nullable OutputStream outputStream, @NonNull SimpleArrayMap<String, Method> simpleArrayMap, @NonNull SimpleArrayMap<String, Method> simpleArrayMap2, @NonNull SimpleArrayMap<String, Class<?>> simpleArrayMap3) {
    ...
    public void writeStrongBinder(@Nullable IBinder iBinder) {
        if (!this.mIgnoreParcelables) {
            throw new RuntimeException("Binders cannot be written to an OutputStream");
        }
    }

    public void writeParcelable(@Nullable Parcelable parcelable) {
        if (!this.mIgnoreParcelables) {
            throw new RuntimeException("Parcelables cannot be written to an OutputStream");
        }
    }

    public void writeStrongInterface(@Nullable IInterface iInterface) {
        if (!this.mIgnoreParcelables) {
            throw new RuntimeException("Binders cannot be written to an OutputStream");
        }
    }
    ...
    private void writeObject(@Nullable Object obj) {
        if (obj == null) {
            writeInt(0);
    ...
    private void readObject(int i, @Nullable String str, @NonNull Bundle bundle) {
        switch (i) {
            case 0:
    ...
    private static class FieldBuffer {
        ...
        FieldBuffer(int i, @NonNull DataOutputStream dataOutputStream) {
