...
public class ArrayLinkedVariables {
    ...
    public final int getVariable(PriorityGoalRow.RowVariable rowVariable, int i) {
        rowVariable.value = this.mArrayValues[i];
        rowVariable.variableId = this.mArrayIndices[i];
        return this.mArrayNextIndices[i];
    }

    public ArrayList<PriorityGoalRow.RowVariable> getVariables() {
        ArrayList<PriorityGoalRow.RowVariable> arrayList = new ArrayList<>();
        int i = this.mHead;
        int i2 = 0;
        while (i != -1 && i2 < this.currentSize) {
