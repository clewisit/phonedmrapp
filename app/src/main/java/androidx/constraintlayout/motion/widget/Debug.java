        ...
        for (Field field : fields) {
            try {
                ...
                if (field.getName().startsWith("layout_constraint")) {
                    if (!(obj2 instanceof Integer) || !obj2.toString().equals(Config.USER_CONFIG_DEFAULT_VALUE)) {
    ...
    public static String getName(Context context, int[] iArr) {
        ...
        while (i < iArr.length) {
            try {
                ...
                sb.append(str);
                str2 = sb.toString() + context.getResources().getResourceEntryName(iArr[i]);
                i++;
            } catch (Exception unused) {
                return "UNKNOWN";
            }
            ...
            for (int i2 = 0; i2 < fields.length; i2++) {
                ...
                try {
                    ...
                    if (field.getName().contains("To")) {
                        if (!obj.toString().equals(Config.USER_CONFIG_DEFAULT_VALUE)) {
