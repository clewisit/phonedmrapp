...
public final class UriCompat {
    ...
    public static String toSafeString(@NonNull Uri uri) {
        ...
        if (scheme != null) {
            if (scheme.equalsIgnoreCase("tel") || scheme.equalsIgnoreCase("sip") || scheme.equalsIgnoreCase(NotificationChannelController.CHANNEL_ID_SMS) || scheme.equalsIgnoreCase("smsto") || scheme.equalsIgnoreCase("mailto") || scheme.equalsIgnoreCase("nfc")) {
