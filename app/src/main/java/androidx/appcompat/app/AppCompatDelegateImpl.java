...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private class AutoBatteryNightModeManager extends AutoNightModeManager {
        ...
        AutoBatteryNightModeManager(@NonNull Context context) {
            super();
            this.mPowerManager = (PowerManager) context.getApplicationContext().getSystemService(XmlTagConst.TAG_POWER);
        }
    ...
    private static Configuration generateConfigDelta(@NonNull Configuration configuration, @Nullable Configuration configuration2) {
        ...
        if (!(configuration2 == null || configuration.diff(configuration2) == 0)) {
            ...
            int i19 = configuration.screenLayout & DnsPacket.DnsRecord.NAME_COMPRESSION;
            int i20 = configuration2.screenLayout;
            if (i19 != (i20 & DnsPacket.DnsRecord.NAME_COMPRESSION)) {
                configuration3.screenLayout |= i20 & DnsPacket.DnsRecord.NAME_COMPRESSION;
            }
