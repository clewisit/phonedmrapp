...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/radio/deprecated/V1_0/IOemHook;
    ...
    .line 27
    instance-of v3, v2, Landroid/hardware/radio/deprecated/V1_0/IOemHook;

    if-eqz v3, :cond_1

    .line 28
    check-cast v2, Landroid/hardware/radio/deprecated/V1_0/IOemHook;

    return-object v2

    .line 31
    :cond_1
    new-instance v2, Landroid/hardware/radio/deprecated/V1_0/IOemHook$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/radio/deprecated/V1_0/IOemHook$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 34
    :try_start_0
    invoke-interface {v2}, Landroid/hardware/radio/deprecated/V1_0/IOemHook;->interfaceChain()Ljava/util/ArrayList;
...
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hardware/radio/deprecated/V1_0/IOemHook;
    ...
    invoke-static {p0}, Landroid/hardware/radio/deprecated/V1_0/IOemHook;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/radio/deprecated/V1_0/IOemHook;
...
.method public static getService()Landroid/hardware/radio/deprecated/V1_0/IOemHook;
    ...
    .line 91
    invoke-static {v0}, Landroid/hardware/radio/deprecated/V1_0/IOemHook;->getService(Ljava/lang/String;)Landroid/hardware/radio/deprecated/V1_0/IOemHook;
...
.method public static getService(Ljava/lang/String;Z)Landroid/hardware/radio/deprecated/V1_0/IOemHook;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public static getService(Z)Landroid/hardware/radio/deprecated/V1_0/IOemHook;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    .line 71
    invoke-static {v0, p0}, Landroid/hardware/radio/deprecated/V1_0/IOemHook;->getService(Ljava/lang/String;Z)Landroid/hardware/radio/deprecated/V1_0/IOemHook;
