.class public final Landroid/internal/telephony/sysprop/BluetoothProperties;
...
# direct methods
.method public static synthetic $r8$lambda$ucopL5Hx1zpiUYmib_lVOjhb6w0(Ljava/lang/String;)Ljava/lang/Integer;
    .locals 0

    invoke-static {p0}, Landroid/internal/telephony/sysprop/BluetoothProperties;->lambda$getClassOfDevice$0(Ljava/lang/String;)Ljava/lang/Integer;
...
.method public static factory_reset()Ljava/util/Optional;
    ...
    .line 210
    invoke-static {v0}, Landroid/internal/telephony/sysprop/BluetoothProperties;->tryParseBoolean(Ljava/lang/String;)Ljava/lang/Boolean;
...
.method private static formatList(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-static {v1}, Landroid/internal/telephony/sysprop/BluetoothProperties;->escape(Ljava/lang/String;)Ljava/lang/String;
...
.method public static getClassOfDevice()Ljava/util/List;
    ...
    .line 229
    new-instance v1, Landroid/internal/telephony/sysprop/BluetoothProperties$$ExternalSyntheticLambda0;

    invoke-direct {v1}, Landroid/internal/telephony/sysprop/BluetoothProperties$$ExternalSyntheticLambda0;-><init>()V

    invoke-static {v1, v0}, Landroid/internal/telephony/sysprop/BluetoothProperties;->tryParseList(Ljava/util/function/Function;Ljava/lang/String;)Ljava/util/List;
...
.method public static getDefaultDeviceName()Ljava/util/Optional;
    ...
    .line 224
    invoke-static {v0}, Landroid/internal/telephony/sysprop/BluetoothProperties;->tryParseString(Ljava/lang/String;)Ljava/lang/String;
...
.method public static getHardwareIdleCurrentMa()Ljava/util/Optional;
    ...
    .line 239
    invoke-static {v0}, Landroid/internal/telephony/sysprop/BluetoothProperties;->tryParseInteger(Ljava/lang/String;)Ljava/lang/Integer;
...
.method private static synthetic lambda$getClassOfDevice$0(Ljava/lang/String;)Ljava/lang/Integer;
    .locals 0

    .line 229
    invoke-static {p0}, Landroid/internal/telephony/sysprop/BluetoothProperties;->tryParseUInt(Ljava/lang/String;)Ljava/lang/Integer;
...
.method public static snoop_default_mode()Ljava/util/Optional;
    ...
    const-string v0, "persist.bluetooth.btsnoopdefaultmode"
    ...
    .line 178
    const-class v1, Landroid/internal/telephony/sysprop/BluetoothProperties$snoop_default_mode_values;

    invoke-static {v1, v0}, Landroid/internal/telephony/sysprop/BluetoothProperties;->tryParseEnum(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;
...
.method public static snoop_default_mode(Landroid/internal/telephony/sysprop/BluetoothProperties$snoop_default_mode_values;)V
    .locals 1
    ...
    .line 182
    :cond_0
    invoke-virtual {p0}, Landroid/internal/telephony/sysprop/BluetoothProperties$snoop_default_mode_values;->getPropValue()Ljava/lang/String;
...
.method public static snoop_log_mode()Ljava/util/Optional;
    ...
    .line 201
    const-class v1, Landroid/internal/telephony/sysprop/BluetoothProperties$snoop_log_mode_values;
...
.method public static snoop_log_mode(Landroid/internal/telephony/sysprop/BluetoothProperties$snoop_log_mode_values;)V
    .locals 1
    ...
    .line 205
    :cond_0
    invoke-virtual {p0}, Landroid/internal/telephony/sysprop/BluetoothProperties$snoop_log_mode_values;->getPropValue()Ljava/lang/String;
...
.method private static tryParseEnumList(Ljava/lang/Class;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 112
    invoke-static {p0, v3}, Landroid/internal/telephony/sysprop/BluetoothProperties;->tryParseEnum(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;
